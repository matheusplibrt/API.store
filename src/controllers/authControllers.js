...
import * as authRepository from "../repositorios/authRepository.js";
...
//Controller para registar o usuário
...
export async function register(req, res) {
  ...
  try {
    ...
    const resposta = await authRepository.createUser({
      nome,
      email,
      senhaHash,
    });
...
export async function login(req, res) {
  ...
  try {
    ...
    res.status(400).json({ message: "Error ao fazer o login" });
  }
}
